...
class opts(object):
    def __init__(self):
        ...
        # you can change the default epochs
        ...
        self.parser.add_argument('--data_cfg', type=str,
                                 default='/content/FairMOT/src/lib/cfg/ourdataset.json',
                                 help='load data from cfg')
        # change this path to your dataset
        self.parser.add_argument('--data_dir', type=str, default='/content/drive/MyDrive/William_house/Cam0')
